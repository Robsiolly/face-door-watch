...
const Prestadores = () => {
  ...
  const data = getPeopleByType("prestador");
  ...
  return (
    <AppLayout>
      ...
      <RegistrationModal isOpen={isRegOpen} onClose={handleCloseReg} type="prestador" personToEdit={editingPerson} />
      <AccessControlModal isOpen={isAccessOpen} onClose={() => setIsAccessOpen(false)} allowedTypes={["prestador"]} />
